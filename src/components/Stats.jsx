...
const stats = [
  {
    ...
    description: 'Tus procesos repetitivos, automatizados por agentes de IA que nunca duermen.',
    icon: (
  ...
  },
  {
    ...
    description: 'Seguimientos automáticos, recordatorios y comunicación personalizada que fideliza.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
  ...
  },
  {
    ...
    description: 'Dueños y directores que ya decidieron llevar su clínica a otra dimensión con KOSMO.',
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth="1.8" viewBox="0 0 24 24">
